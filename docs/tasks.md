...
- **Notas 2026-05-11:** La hoja de personaje abierto fue reorganizada en secciones Figma con métricas superiores, estado opcional de penalización en sigilo, XP, imagen/atributos, magia y PG separados por dividers rojos degradados. Se corrigió la cascada para que los dividers sean visibles y se fijó el orden `FUE`, `DES`, `CON` / `INT`, `SAB`, `CAR`. Falta QA visual contra los estados con/sin penalización.
- **Status:** `[~]`
