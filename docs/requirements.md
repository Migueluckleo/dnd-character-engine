...
- Buttons in New Style screens must be standardized as mini, regular, close, primary, secondary, and ghost variants via shared tokens/classes before local overrides are added. Current Figma token sizes: mini `24px`, regular `44px`, modal close `32px`.
