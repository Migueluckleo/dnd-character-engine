...
- El botón `Agregar experiencia` en la hoja es mini: 24px de alto, `Source Serif Pro` 10px regular y padding horizontal de 8px. No debe llevar clases genéricas `btn`, `btn-accent` ni `btn-full`, porque lo vuelven a convertir en botón regular/grande.
